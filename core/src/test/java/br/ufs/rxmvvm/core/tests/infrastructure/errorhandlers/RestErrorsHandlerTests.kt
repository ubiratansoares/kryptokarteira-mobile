package br.ufs.rxmvvm.core.tests.infrastructure.errorhandlers

import br.ufs.rxmvvm.core.errors.InfrastructureError.RemoteSystemDown
import br.ufs.rxmvvm.core.errors.InfrastructureError.UndesiredResponse
import br.ufs.rxmvvm.core.infrastructure.errorhandlers.RestErrorsHandler
import br.ufs.rxmvvm.core.tests.util.Fixtures
